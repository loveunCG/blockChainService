...
import (
	...
	"github.com/dappbox/dappbox/lib/rc"
)

var homeDir = "h1"
var dappboxBin = "./bin/dappbox"
var test = "scan"

func main() {
	flag.StringVar(&homeDir, "home", homeDir, "Home directory location")
	flag.StringVar(&dappboxBin, "bin", dappboxBin, "Binary location")
...
func testScan() {
	...
	if err := p.Start(dappboxBin, "-home", homeDir, "-no-browser"); err != nil {
		log.Println(err)
		return
	}
	defer p.Stop()
