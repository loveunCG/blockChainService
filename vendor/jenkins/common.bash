...
function fetchExtra {
    ...
    mkdir extra
    curl -s -o extra/Getting-Started.pdf https://docs.dappbox.net/pdf/Getting-Started.pdf
    curl -s -o extra/FAQ.pdf https://docs.dappbox.net/pdf/FAQ.pdf
    echo
}
...
function buildSource {
    ...
    pushd .. >/dev/null
    tar c -z -f "$WORKSPACE/dappbox-source-$version.tar.gz" --exclude .git dappbox
    popd >/dev/null
    echo
}
