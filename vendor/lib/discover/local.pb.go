...
type Announce struct {
	ID         github_com_dappbox_dappbox_lib_protocol.DeviceID `protobuf:"bytes,1,opt,name=id,proto3,customtype=github.com/dappbox/dappbox/lib/protocol.DeviceID" json:"id"`
