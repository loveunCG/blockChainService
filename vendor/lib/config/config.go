...
type Configuration struct {
	...
	Categories     []CategoryConfiguration	`xml:"category" json:"categories"`
...
func (cfg Configuration) Copy() Configuration {
	...
	newCfg.Categories = make([]CategoryConfiguration, len(cfg.Categories))
	for i := range newCfg.Categories{
		newCfg.Categories[i] = cfg.Categories[i].Copy()
	}
...
func (cfg *Configuration) clean() error {
	...
	if cfg.Categories == nil{
		cfg.Categories = []CategoryConfiguration{}
	}
...
func convertV19V20(cfg *Configuration) {
	...
	cfg.Options.StoreInfluxDb = false
...
func convertV13V14(cfg *Configuration) {
	...
	if cfg.Options.ReleasesURL == "https://api.github.com/repos/dappbox/dappbox/releases?per_page=30" {
