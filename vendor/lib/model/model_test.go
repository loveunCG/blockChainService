...
import (
	...
	srand "github.com/dappbox/dappbox/lib/rand"
...
func TestRequest(t *testing.T) {
	...
	m := NewModel(defaultConfig, protocol.LocalDeviceID, "dappbox", "dev", db, nil)
...
func TestDeviceRename(t *testing.T) {
	...
	db := db.OpenMemory()
	m := NewModel(cfg, protocol.LocalDeviceID, "dappbox", "dev", db, nil)
...
func TestClusterConfig(t *testing.T) {
	...
	m := NewModel(config.Wrap("/tmp/test", cfg), protocol.LocalDeviceID, "dappbox", "dev", db, nil)
...
func TestIntroducer(t *testing.T) {
	...
	newState := func(cfg config.Configuration) (*config.Wrapper, *Model) {
		...
		m := NewModel(wcfg, protocol.LocalDeviceID, "dappbox", "dev", db, nil)
...
func TestROScanRecovery(t *testing.T) {
	...
	m := NewModel(cfg, protocol.LocalDeviceID, "dappbox", "dev", ldb, nil)
	m.AddFolder(fcfg)
	m.StartFolder("default")
	m.ServeBackground()
	defer m.Stop()
...
func TestIssue2782(t *testing.T) {
	...
	testName := ".dappbox-test." + srand.String(16)
...
func TestIndexesForUnknownDevicesDropped(t *testing.T) {
	...
	m := NewModel(defaultConfig, protocol.LocalDeviceID, "dappbox", "dev", dbi, nil)
	m.AddFolder(defaultFolderConfig)
	m.StartFolder("default")
...
func TestSharedWithClearedOnDisconnect(t *testing.T) {
	...
	m := NewModel(wcfg, protocol.LocalDeviceID, "dappbox", "dev", dbi, nil)
	m.AddFolder(fcfg)
