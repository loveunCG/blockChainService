...
type Folder struct {
	...
	IgnorePermissions  bool     `protobuf:"varint,5,opt,name=ignore_permissions,json=ignorePermissions,proto3" json:"ignore_permissions,omitempty"`
	IgnoreDelete       bool     `protobuf:"varint,6,opt,name=ignore_delete,json=ignoreDelete,proto3" json:"ignore_delete,omitempty"`
	DisableTempIndexes bool     `protobuf:"varint,7,opt,name=disable_temp_indexes,json=disableTempIndexes,proto3" json:"disable_temp_indexes,omitempty"`
...
type Device struct {
  ...
  EthAddress               string      `protobuf:"bytes,10,opt,name=ethaddress,proto3" json:"ethaddress,omitempty"`
}
...
func (m *Folder) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Categories) > 0 {
		dAtA[i] = 0x18
		i++
		i = encodeVarintBep(dAtA, i, uint64(len(m.Categories)))
...
func (m *Device) MarshalTo(dAtA []byte) (int, error) {
    ...
    if len(m.EthAddress) > 0 {
		dAtA[i] = 0x50
		i++
		i = encodeVarintBep(dAtA, i, uint64(len(m.EthAddress)))
