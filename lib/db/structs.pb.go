...
import protocol "github.com/dappbox/dappbox/lib/protocol"

import github_com_dappbox_dappbox_lib_protocol "github.com/dappbox/dappbox/lib/protocol"
...
type FileInfoTruncated struct {
	...
	ModifiedBy    github_com_dappbox_dappbox_lib_protocol.ShortID `protobuf:"varint,12,opt,name=modified_by,json=modifiedBy,proto3,customtype=github.com/dappbox/dappbox/lib/protocol.ShortID" json:"modified_by"`
	...
	for iNdEx < l {
		...
		case 12:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ModifiedBy |= (github_com_dappbox_dappbox_lib_protocol.ShortID(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
