...
*                                                                             *
*   https://github.com/dappbox/dappbox/issues                             *
*                                                                             *
...
*   https://docs.DappBox.net/users/faq.html#my-DappBox-database-is-corrupt  *
*********************************************************************************
`)
				} else {
					l.Warnln("Please check for existing issues with similar panic message at https://github.com/dappbox/dappbox/issues/")
